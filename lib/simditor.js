  ...
  InputManager.prototype._init = function() {
    ...
    this.editor.on('valuechanged', (function(_this) {
      return function() {
        ...
        _this.editor.body.find('hr, pre, .simditor-table, s-audio').each(function(i, el) {
          var $el, formatted;
          $el = $(el);
  ...
  Keystroke.prototype._initKeystrokeHandlers = function() {
    ...
    this.add('backspace', '*', (function(_this) {
      return function(e) {
        ...
        if (($prevBlockEl.is('hr') || $prevBlockEl.find('s-audio').length != 0) && _this.editor.selection.rangeAtStartOf($rootBlock)) {
          _this.editor.selection.save();
          $prevBlockEl.remove();
          _this.editor.selection.restore();
          return true;
